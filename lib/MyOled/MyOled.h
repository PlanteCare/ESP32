...
/* Copyright (C) 2020 Alain Dube */
 ...
 public:
     ...
     void printWeather(int posx, int posy);
     void printIt(const char *toDisplay, bool displayAfter, int makeDelaySecondes = 0);
     void printIt(int posx, int posy, const char *toDisplay, bool displayAfter, int makeDelaySecondes = 0);
     bool veilleCheck();
